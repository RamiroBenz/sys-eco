...
<html>
<head>
	<title>Lola Morena: Tienda Online de Lenceria </title>
	<meta charset="utf-8">
...
<body>
	<header style="--main-header-color: linear-gradient(45deg, #520303, #7d0505);
	    --main-red: #7d0505;">
		<div class="logo-place"><a href="index.php"><img src="assets/logo_lm.jpg" style=" width:40px; border-radius: 5px;"></a></div>
	</header>
