...
<html>
<head>
	<title>Tienda Online Lola Morena Lenceria..</title>
	<meta charset="utf-8">
...
<body>
    ...
    --main-red: #7d0505; color: black;">
		<div class="logo-place">
			<a href="index.php">
				<img src="assets/LolaMora.png" style="width: 70px; border-radius: 5px;"></a></div>
	...
	<div class="main-content">
		<div class="content-page">
			...
			<div class="metodo-pago">
				...
				<label for="tipo2">Pago con tarjeta de credito/debito</label>
			</div>
			...
			$.ajax({
				...
				success:function(data){
				    ...
				    Culqi.settings({
				        title: 'Mi tienda',
				        currency: 'PEN',
				        description: 'Lola Morena Lenceria',
				        amount: sumaMonto
				    });
